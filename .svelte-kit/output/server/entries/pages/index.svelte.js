import { c as create_ssr_component, a as compute_rest_props, d as spread, j as escape_attribute_value, e as escape_object, h as escape, k as compute_slots, l as getContext, v as validate_component, f as add_attribute, g as add_classes, m as missing_component } from "../../chunks/index-4b7ffe26.js";
...
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"page pt-[16vh] grid grid-cols-12 items-center h-screen "}"><figure class="${"icon col-span-12 justify-self-center "}">${validate_component(Icon, "Icon").$$render($$result, { icon: "logos:whatsapp", width: "200" }, {}, {})}</figure>
    <header class="${"font-bold col-span-12 justify-self-center "}">Welcome to  Whatsapp
    </header>
    
        <div class="${"col-span-12 justify-self-center transition hover:scale-[1.2] duration-700 "}">${validate_component(Button, "Button").$$render($$result, {}, {}, {
    default: () => {
